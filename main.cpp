...
int main()
{
	...
	while (1){
		...
		switch (lua_chon)
		{
		case 6:                     //1.1 Tim kiem phong
			Thucthi_Timkiem_phong();
			break;
		case 7:                     //1.2 Them phong
			while (1)
				{
			...
			break;
		case 8:                    //1.3 Sua thong tin phong
			Sua_thongtin_phong();	
				break;
		case 9:                    //1.4 Xoa phong
			t_exit = 0;
			while (!t_exit)
			{
				t_exit = Xoa_phong();
			...
			break;	
		case 10:                  //1.5 Ds phong
			Hienthi_Ql_phong_ds();
			break;
		case 12:                  //2.1 Tim kiem khach hang
			Thucthi_Timkiem_khachhang();
			break;
		case 13:                  //2.2 Them khach hang
			while (1)
			{
			...
			break;
		case 14:                  //2.3 Sua thong tin khach hang
			Sua_thongtin_khachhang();
			break;
		case 15:                 //2.4 Xoa khach hang
			t_exit = 0;
			while (!t_exit)
			{
			...
			break;
		case 16:                 //2.5 Danh phong khach hang
			Hienthi_Ql_khachhang_ds();
			break;
		case 18:                  //3.1 Dat phong
			while (1)
			{
				Khung_Ql_dat_phong();
		...
		case 19:                 //3.2 Tra phong		
			...
			break;
		case 21:                 //4.1 Hoa don theo phong
			Hoadon_theophongkh();
			break;
		case 22:                //4.2 Hoa don theo ngay
			Hoadon_theongay();
			break;
		case 23:                //4.3 Lich su lua tru
			Lichsu_luutru();
			break;
		case 100:              
